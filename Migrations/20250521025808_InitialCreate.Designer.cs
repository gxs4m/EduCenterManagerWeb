...
namespace EduCenterManagerWeb.Migrations
{
    ...
    [Migration("20250521025808_InitialCreate")]
            ...
            modelBuilder.Entity("EduCenterManagerWeb.Models.Courses", b =>
                {
                    ...
                    b.Property<int?>("TeachersIdProfesor")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TeachersIdProfesor");
            ...
            modelBuilder.Entity("EduCenterManagerWeb.Models.Ratings", b =>
                {
                    ...
                    b.Property<int?>("StudentsIdEstudiante")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentsIdEstudiante");
            ...
            modelBuilder.Entity("EduCenterManagerWeb.Models.Courses", b =>
                {
                    b.HasOne("EduCenterManagerWeb.Models.Teachers", "Teachers")
                        .WithMany()
                        .HasForeignKey("TeachersIdProfesor");
            ...
            modelBuilder.Entity("EduCenterManagerWeb.Models.Ratings", b =>
                {
                    ...
                    b.HasOne("EduCenterManagerWeb.Models.Students", "Students")
                        .WithMany("Ratings")
                        .HasForeignKey("StudentsIdEstudiante");
